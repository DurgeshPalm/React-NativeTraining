...
const [initialValues, setInitialValues] = useState({ name: '', email: '', password: '' });
  ...
  return (
    <View style={styles.container}>
      ...
      router.push({pathname:'/',params: { name:values.name, email: values.email}})     
      resetForm();
    ...
    />
            <LoginInput
              ...
              setIsFocused={(focus) => setFocusField((prev) => ({ ...prev, email: focus }))}
            />
            <LoginInput
              ...
              setIsFocused={(focus) => setFocusField((prev) => ({ ...prev, password: focus }))}
